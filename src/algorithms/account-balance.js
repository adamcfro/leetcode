 ...
 * 10 and abs(roundedAmount - purchaseAmount) is minimized. If there is more 
 * than one nearest multiple of 10, the largest multiple is chosen.
 * 
 ...
 * 
 * @param {number} purchaseAmount - A number representing money that is spent
 * @returns {number} - Returns a number representing an account balance after 
 *     making a purchase
 */
