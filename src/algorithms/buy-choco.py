def buy_choco(prices, money):
    ...
    Args:
        prices (list[int]): A list of integers representing chocolate prices.
        money (int): An integer representing an initial amount of money.

    Returns:
        int: Returns the amount of money leftover after buying two chocolates.
    """
