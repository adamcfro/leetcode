 ...
 *
 * @format
 * @param {number[]} tickets - An array of numbers representing desired tickets
 * @param {number} k - A number representing a person's position in line
 * @returns {number} - Returns the time taken for the kth person to buy tickets
 */
