def array_strings_are_equal(word1, word2):
    ...
    A string is represented by an array if the array elements concatenated in order forms the string. Given two string arrays word1 and word2, return true if the two arrays represent the same string, and false otherwise.
