/**
 * You are given an integer array target and an integer n. You have an empty
 * stack with the two following operations:
 ...
 *     top) are equal to target, do not read new integers from the stream and
 *     do not do more operations on the stack.
