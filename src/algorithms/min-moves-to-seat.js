 ...
 *
 * @format
 * @param {number[]} seats - A 2D array representing seat numbers
 * @param {number[]} students - A 2D array representing student seat numbers
 * @returns {number} - Returns a count of moves needed to properly seat students
 */
